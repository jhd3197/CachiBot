...
export function CompleteStep() {
  ...
  return (
    <div className="flex flex-col items-center py-8 text-center">
      ...
      <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">You're All Set!</h2>
      ...
      <div className="mt-6 w-full max-w-sm space-y-3 text-left">
        {configuredProviders.length > 0 && (
          <div className="rounded-lg border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-800/50 p-3">
            <p className="text-xs font-medium uppercase tracking-wider text-zinc-500">Providers</p>
            <p className="mt-1 text-sm text-zinc-800 dark:text-zinc-200">{configuredProviders.join(', ')}</p>
          </div>
        )}
        ...
        {defaultModel && (
          <div className="rounded-lg border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-800/50 p-3">
            ...
            <p className="mt-1 font-mono text-sm text-zinc-800 dark:text-zinc-200">{defaultModel}</p>
          </div>
        )}
      ...
      >
        ...
        <div className="flex-1 text-left">
          <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Enjoying CachiBot?</p>
          <p className="text-xs text-zinc-500 dark:text-zinc-400">Star us on GitHub to show your support!</p>
        </div>
