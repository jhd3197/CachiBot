...
export function SmtpStep() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-lg font-semibold text-zinc-100">Email Configuration</h3>
      ...
      <div className="space-y-3 rounded-lg border border-zinc-800 bg-zinc-800/30 p-4">
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="mb-1 block text-xs font-medium text-zinc-400">SMTP Host</label>
            <input
              type="text"
              value={host}
              onChange={(e) => { setHost(e.target.value); markDirty() }}
              placeholder="smtp.gmail.com"
              className="h-9 w-full rounded-lg border border-zinc-700 bg-zinc-800 px-3 text-sm text-zinc-100 outline-none transition-colors placeholder:text-zinc-600 focus:border-accent-500"
            />
          </div>
          <div>
        ...
        <div>
          <label className="mb-1 block text-xs font-medium text-zinc-400">From Address</label>
          <input
            type="email"
            value={fromAddress}
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={cn(
              ...
              useTls ? 'bg-accent-600' : 'bg-zinc-600'
            )}
          >
            <span
              className={cn(
          ...
          <span className="text-sm text-zinc-300">Use TLS</span>
        </div>
        ...
        <div className="border-t border-zinc-700 pt-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="h-9 flex-1 rounded-lg border border-zinc-700 bg-zinc-800 px-3 text-sm text-zinc-100 outline-none transition-colors placeholder:text-zinc-600 focus:border-accent-500"
            />
          </div>
        </div>
