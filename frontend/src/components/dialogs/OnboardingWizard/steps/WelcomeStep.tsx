...
export function WelcomeStep() {
  return (
    <div className="flex flex-col items-center py-8 text-center">
      ...
      <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Welcome to CachiBot</h2>
      ...
      <div className="mt-8 grid w-full max-w-sm gap-3">
        <div className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-3 text-left dark:border-zinc-800 dark:bg-zinc-800/50">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-blue-500/20">
            <Key className="h-4 w-4 text-blue-400" />
          </div>
          <div>
            <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Connect a Provider</p>
        ...
        <div className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-3 text-left dark:border-zinc-800 dark:bg-zinc-800/50">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Pick a Model</p>
        ...
        <div className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-3 text-left dark:border-zinc-800 dark:bg-zinc-800/50">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Database</p>
        ...
        <div className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-3 text-left dark:border-zinc-800 dark:bg-zinc-800/50">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Email</p>
        ...
        <div className="flex items-center gap-3 rounded-lg border border-zinc-200 bg-zinc-50 p-3 text-left dark:border-zinc-800 dark:bg-zinc-800/50">
          ...
          <div>
            <p className="text-sm font-medium text-zinc-800 dark:text-zinc-200">Personalize</p>
