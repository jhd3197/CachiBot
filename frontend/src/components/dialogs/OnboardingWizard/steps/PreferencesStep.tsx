...
export function PreferencesStep() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-zinc-900 dark:text-zinc-100">Personalize Your Experience</h3>
      ...
      <div className="space-y-2">
        <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Color Theme</label>
            ...
            <button
              ...
              className={cn(
                ...
                theme === option.value
                  ...
                  : 'border-zinc-300 bg-zinc-100 text-zinc-700 hover:border-zinc-400 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 dark:hover:border-zinc-600'
              )}
            >
      ...
      <div className="space-y-4">
        <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Display Options</label>
        <ToggleItem
...
function ToggleItem({
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-800/50 p-3">
      <div>
