...
- [ ] **MODL-02**: Selected model override is sent with the WebSocket chat message and used for that response
- [ ] **MODL-03**: Model used for each message is stored in message metadata and displayed in the chat bubble
